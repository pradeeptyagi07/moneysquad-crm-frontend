// src/store/slices/associateSlice.ts
...
>(
  ...
  async (data, { rejectWithValue }) => {
    try {
      ...
      const response = await axiosInstance.post("/associate/create", formData);
...
>(
  ...
  async (_, { rejectWithValue }) => {
    try {
      const response = await axiosInstance.get("/associate");
      return response.data.data as Associate[];
    } catch (error: any) {
      return rejectWithValue(
...
>(
  ...
  async (id, { rejectWithValue }) => {
    try {
      await axiosInstance.delete(`/associate/delete/${id}`);
      return id;
    } catch (error: any) {
      return rejectWithValue(
